...
$lang['gravatarURL']                  = 'Set Gravatar URL <dl class="dl-horizontal"><dt>HTTPS</dt><dd><code>https://secure.gravatar.com/avatar</code></dd><dt>HTTPS (alternative)</dt><dd><code>https://www.gravatar.com/avatar</code></dd></ul>';
...
$lang['libravatarURL']                = 'Set Libravatar (or compatible API) URL <dl class="dl-horizontal"><dt>HTTPS</dt><dd><code>https://seccdn.libravatar.org/avatar</code></dd><dt>HTTP</dt><dd><code>http://cdn.libravatar.org/avatar</code></dd></ul>';

...
$lang['collapsibleSections']          = '2. Ebene zusammenklappen (nützlich bei mobilen Endgeräten)';
...
$lang['showSearchButton']             = 'Zeigt die Suchen Schaltfläche in der Navigationsleiste';
...
$lang['useACL']                       = 'Benutze die Zugangskontrolle für die Seitenleiste (links und rechts) und für alle DokuWiki Template Hooks (z.B.. <code>:footer</code>, <code>:navbar</code>, etc.) <br/> <strong>HInweis:</strong> Verfügbar seit Release "Elenor of Tsort"';

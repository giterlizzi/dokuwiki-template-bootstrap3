...
$lang['collapsibleSections']          = '折叠2级选择层级(用于移动设备)';
...
$lang['pageToolsAnimation']           = '启用页面工具动画';
...
$lang['showSearchButton']             = '在导航栏显示分享按钮';
...
$lang['sidebarOnNavbar']              = '在导航栏显示侧栏目录';
...
$lang['useACL']                       = '对于侧边栏(左和右)和所有DokuWiki hooks 使用 ACL(eg. <code>:footer</code>, <code>:navbar</code>, etc.) <br/> <strong>备注:</strong> 可用于 "Elenor of Tsort" 发行';

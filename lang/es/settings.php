...
$lang['collapsibleSections']          = 'Contraer secciones de 2do nivel (útil para dispositivos móviles)';
...
$lang['showSearchButton']             = 'Mostrar botón de búsqueda en la barra de navegación';
...
$lang['useACL']                       = 'Usar ACL para barras laterales (izquierda y derecha) y para todos los ganchos DokuWiki (por ejemplo, <code>:footer</code>, <code>:navbar</code>, etc.) <br/> <strong>NOTA:</strong> Disponible desde la versión "Elenor of Tsort"';

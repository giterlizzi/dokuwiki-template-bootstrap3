...
$lang['showSearchButton']             = 'ナビゲーション・バー内に検索ボタンを表示する';
...
$lang['useACL']                       = '(左右の)サイドバーと DokuWiki フック(例：<code>:footer</code>・<code>:navbar</code> 等)に対してアクセス制御リストを使用する。<br/> <strong>注：</strong>"Elenor of Tsort" release 以降で使用可能です。';

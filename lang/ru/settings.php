...
$lang['sidebarPosition_o_right']               = 'справа';
$lang['sidebarPosition_o_left']                = 'слева';
$lang['rightSidebar']                          = 'Имя страницы правой боковой панели, пустое поле отключает панель. Правая боковая панель отображается только если <a href="#config___sidebar">боковая панель</a> Dokuwiki по умолчанию включена и находится <code>слева</code>. (Смотреть <a href="#config___tpl____bootstrap3____sidebarPosition">tpl»bootstrap3»sidebarPosition</a>). Если вы хотите видеть панель навигации Dokuwiki по умолчанию спава, установите <code>справа</code> в <a href="#config___tpl____bootstrap3____sidebarPosition">tpl»bootstrap3»sidebarPosition</a>';
...
$lang['bootstrapTheme_o_default-optional']     = 'Bootstrap дополнительная';
